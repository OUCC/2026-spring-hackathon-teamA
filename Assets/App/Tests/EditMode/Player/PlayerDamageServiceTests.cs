...
namespace FloorBreaker.Tests.EditMode.Player
{
    ...
    public class PlayerDamageServiceTests
    {
        ...
        public void SetUp()
        {
            ...
            _svc = new PlayerDamageService(invulnerabilityDuration: 1.5f, forcedMoveDuration: 1f, _stage, _safeTile);
        }
        ...
        {
            _svc.ApplyDamage(_player, 3, false, new HashSet<GridPos>());
        ...
        {
            _svc.ApplyDamage(_player, 1, false, new HashSet<GridPos>());
        ...
        public void ApplyDamage_WhileInvulnerable_IsIgnored()
        {
            ...
            var result = _svc.ApplyDamage(_player, 3, false, new HashSet<GridPos>());
        ...
        {
            _stage.SetTileCondition(new GridPos(5, 5), TileCondition.Collapsing);
            _svc.ApplyDamage(_player, 2, true, new HashSet<GridPos>());
        ...
        {
            _svc.ApplyDamage(_player, 2, false, new HashSet<GridPos>());
